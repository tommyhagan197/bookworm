          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1px" }}>
            {works.map((work, i, arr) => (
              <div key={work.id} style={{
                ...
                <div>
                  <div style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "var(--text)", lineHeight: 1.3 }}>{work.title}</div>
                  <div style={{ fontSize: "12px", color: "var(--text-muted)", marginTop: "3px" }}>{work.pageCount} {work.pageCount === 1 ? "page" : "pages"}</div>
                </div>
              </div>
            ))}
          </div>
